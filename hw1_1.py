...
# 이미지를 불러오세요.
image_path = 'img_1.png'  # 이미지 파일 경로를 지정하세요.
...
# 교차점의 좌표를 튜플로 변환하여 set에 추가
unique_corners = set(tuple(corner) for corner in corners)
# 중복이 제거된 교차점 개수 출력
print(f"Unique corners count: {len(unique_corners)}")
